...
import { createDoctorSchema } from "@/app/(authenticated)/dashboard/(admin)/doctors/types";
import { specialties } from "@/app/(authenticated)/dashboard/constants";
import { createDoctor } from "@/app/(authenticated)/dashboard/(admin)/doctors/actions";
