  ...
  const tabs = [
    {
      key: "laboratory",
      label: "Laboratory",
      data: consultation.laboratories
        ? consultation.laboratories.split(",")
        : [],
    },
    {
      key: "medicine",
      label: "Medicine",
      data: consultation.medicines ? consultation.medicines.split(",") : [],
    },
    {
      key: "radiology",
      label: "Radiology",
      data: consultation.radiologies ? consultation.radiologies.split(",") : [],
    },
